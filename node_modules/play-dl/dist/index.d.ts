 ...
 */
declare function setToken(options: tokenOptions): void;
...
export { Deezer, DeezerAlbum, DeezerPlaylist, DeezerTrack, SoundCloud, SoundCloudPlaylist, SoundCloudStream, SoundCloudTrack, Spotify, SpotifyAlbum, SpotifyPlaylist, SpotifyTrack, YouTube, YouTubeChannel, YouTubePlayList, YouTubeVideo, attachListeners, authorization, decipher_info, deezer, _default as default, dz_advanced_track_search, dz_validate, extractID, getFreeClientID, is_expired, playlist_info, refreshToken, search, setToken, so_validate, soundcloud, sp_validate, spotify, stream, stream_from_info, validate, video_basic_info, video_info, yt_validate };
